 ...
 * chars.
 * 
 * Can be achieved in JavaScript by unescape(encodeURIComponent(str)), but this
 * approach may be useful in other languages.
 * 
 * @param {string}
 ...
 * 
 * Can be achieved JavaScript by decodeURIComponent(escape(str)), but this
 * approach may be useful in other languages.
 * 
 * @param {string}
